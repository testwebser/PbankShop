const gameDetails = {
    "devour": {
        ...
        features: [
            ...
            "บรรยากาศสยองขวัญสุดหลอน",
            "ภารกิจที่ท้าทายและน่าตื่นเต้น",
            "ตัวละครผีที่มีปัญญาประดิษฐ์ขั้นสูง",
            "หลายแผนที่ให้เลือกเล่น"
        ],
        systemRequirements: {
            minimum: [
                "OS: Windows 7 64-bit",
    ...
    "pummel-party": {
        ...
        features: [
            ...
            "มินิเกมหลากหลายกว่า 30 เกม",
            "แผนที่และธีมที่แตกต่างกัน",
            "ไอเท็มและกลยุทธ์ที่หลากหลาย",
            "กราฟิกแบบการ์ตูน 3D สีสันสดใส"
        ],
        systemRequirements: {
            minimum: [
                ...
                "Memory: 4 GB RAM",
                "Graphics: GeForce GTX 460 / Radeon HD 7850",
    ...
    "the-sims-4": {
        ...
        features: [
            ...
            "ควบคุมชีวิตประจำวันของ Sims ของคุณ",
            "สำรวจโลกและชุมชนต่างๆ",
            "เพิ่มเติมเนื้อหาด้วย Expansion Packs และ Game Packs"
        ],
        systemRequirements: {
            minimum: [
                "OS: Windows 10 (64-bit)",
    ...
    "silent-hill-2": {
        ...
        features: [
            ...
            "บรรยากาศสยองขวัญที่เป็นเอกลักษณ์",
            "ปริศนาและเกมเพลย์ที่ท้าทาย",
            "ตัวละครที่มีมิติและน่าสนใจ",
            "เสียงประกอบและดนตรีที่สร้างบรรยากาศได้อย่างยอดเยี่ยม"
        ],
        systemRequirements: {
            minimum: [
                "OS: Windows 10 64-bit",
                ...
                "Memory: 12 GB RAM",
                "Graphics: AMD Radeon RX 5600 XT or NVIDIA GeForce GTX 1080",
    ...
    "dragon-ball-sparking-zero": {
        ...
        features: [
            ...
            "ตัวละครหลากหลายจากจักรวาล Dragon Ball",
            "โหมดการเล่นหลายรูปแบบ ทั้งแบบเนื้อเรื่องและออนไลน์",
            "กราฟิกสวยงามที่จำลองบรรยากาศของอนิเมะได้อย่างยอดเยี่ยม",
            "ท่าไม้ตายและการแปลงร่างที่น่าตื่นตาตื่นใจ"
        ],
        systemRequirements: {
            minimum: [
                "OS: Windows 10 64-bit",
    ...
    "sea-of-thieves": {
        ...
        downloadLinks: {
            ...
            patch: [
                ...
                { url: "https://pixeldrain.com/u/ZETeANW2", name: "SoT.v2.135.4044.0.to.2.135.8227.0"}
            ],
        },
        passwords: { 
            game: "online-fix.me",
